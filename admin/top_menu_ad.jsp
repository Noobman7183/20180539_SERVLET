...
<nav class="navbar navbar-expand navbar-dark bg-dark" style="height:80;">
    ...
    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="../member/member_view.jsp">회원 수정 및 삭제</a>
     </ul>
	</div>
	<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="../admin/index_ad.jsp">상품 보기</a>
        <a class="dropdown-item" href="../admin/product_add.jsp">상품 등록</a>
        <a class="dropdown-item" href="../admin/product_edit.jsp">상품 수정 및 삭제</a>
     </ul>
	</div>
