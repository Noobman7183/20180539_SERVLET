...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cartButton').click(function() {
            var productId = '<%= filteredList.get(0).getProductId() %>';
            var productName = '<%= filteredList.get(0).getPname() %>';
            var productThumbnail = '<%= filteredList.get(0).getThumbnail() %>';
            var productPrice = '<%= filteredList.get(0).getUnitPrice() %>';
